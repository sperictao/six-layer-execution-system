...
Evidence:
- `roadmaps/execution-system-spec-v1-roadmap.md`
- `roadmaps/one-publish-refactor-roadmap.md`
...
Evidence:
- `tasks/execution-system-spec-v1-tasks.md`
- `tasks/one-publish-refactor-tasks.md`
...
- [ ] `pass` `one-publish` has a dedicated contract file
...
- [ ] `pass` one-publish strategic decisions exist as durable records

Evidence:
- `decisions/runtime/`
- `decisions/one-publish/`
...
- [ ] `pass` business focus has been handed back to `one-publish-refactor`
- [ ] `pass` focus-first validation is green under business focus
...
python3 /Users/erictao/source/repos/six-layer-execution-system/scripts/test_slice_closeout_state.py
PYTHONPATH=/Users/erictao/source/repos/six-layer-execution-system python3 /Users/erictao/source/repos/six-layer-execution-system/scripts/test_run_execution_system_checks.py
python3 /Users/erictao/source/repos/six-layer-execution-system/scripts/test_check_oversized_migration_slices.py
python3 /Users/erictao/source/repos/six-layer-execution-system/scripts/test_check_task_slice_schema.py
python3 /Users/erictao/source/repos/six-layer-execution-system/scripts/test_check_active_consistency.py
```
...
- `accept_active_ledger_v2.py` should be fully green under a valid business focus
